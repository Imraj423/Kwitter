  ...
  render() {
    ...
    return (
      <>
        ...
        <p>Username: Imraj</p>
       <ErrorBoundary> <p>Display Name: {this.props.user.displayName}</p>
       </ErrorBoundary><ErrorBoundary><p>About: {this.props.user.about}</p>
       </ErrorBoundary> <ErrorBoundary> <p>Created: {new Date(this.props.user.createdAt).toDateString()}</p>
       </ErrorBoundary><ErrorBoundary> <p>Updated: {new Date(this.props.user.updatedAt).toDateString()}</p>
        </ErrorBoundary>{isOwnProfile && (
          <>

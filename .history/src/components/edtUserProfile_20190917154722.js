  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <p><h2>This is the user profile. Welcome!</h2></p>

        <p><h3>Username: {this.props.user.username}</h3></p>
        <p><h3>Display Name: {this.props.user.displayName}</h3></p>
        <p><h3>About: {this.props.user.about}</h3></p>

    ...
    return (
        <div style={{ height: 70, backgroundColor: 'white' }}>
            <Tabs style={{
                ...
                inkBarStyle={{ color: 'blue', background: '#00aced' }} style={{
                    marginLeft: '130px', marginTop: '', height: '20%', width: '35%',
                ...
                <div style={{ marginLeft: '145%', marginTop: '-15%' }}>
                    <List >
                        <ListItem style={{ marginTop: '5px' }}
                            disabled={true}
                            leftAvatar={
                                <IconButton onClick={this.dropdown} style={{ marginTop: -10, marginLeft: -5 }}><Background /></IconButton>
                            }
                        >

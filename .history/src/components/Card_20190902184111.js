        ...
        <CardContent>
          ...
          <CardActions>
            ...
            <div className={classes.hLinks}>
              <a href="https://www.facebook.com" class={classes.ilink}>Facebook</a>
              <br />
              <br />
              <a href="https://www.linkedin.com" class={classes.ilink}>LinkedIn</a>
              <br />
              <br />
              <a href="https://www.instagram.com" class={classes.ilink}>Instagram</a>
              <br />
              <br />
            </div>
          </CardActions>
